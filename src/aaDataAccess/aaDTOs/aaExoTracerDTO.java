...
public class aaExoTracerDTO {
    private Integer aaIdEvento;
    private String  aaFecha;
    private String  aaDescripcion;
    private String  aaEstado; // "GOOD" o "ERROR"

    
    public aaExoTracerDTO() {
    }
    
    public aaExoTracerDTO(String aaDescripcion, String aaEstado) {
        this.aaDescripcion = aaDescripcion;
        this.aaEstado = aaEstado;
    }
    
    public aaExoTracerDTO(Integer aaIdEvento, String aaFecha, String aaDescripcion, String aaEstado) {
