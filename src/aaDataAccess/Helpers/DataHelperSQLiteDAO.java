...
public class DataHelperSQLiteDAO <T> implements IDAO<T> {
    ...
    @Override
    public Integer getMaxReg() throws aaAppException {
    ...
    protected List<T> mapResultSetToEntityList(ResultSet rs) throws aaAppException {
    List<T> list = new ArrayList<>();
        try {
            while (rs.next()) {
                list.add(mapResultSetToEntity(rs));
            ...
            throw new aaAppException(null, e, getClass(), "mapResultSetToEntityList");
        }
    }


    public <T> T executeInTransaction(Function<Connection, T> work) throws aaAppException {
        try (Connection conn = DriverManager.getConnection(DBPath)) {
            ...
            throw new aaAppException("Error en transacción", e, getClass(), "executeInTransaction");
        }
    }
